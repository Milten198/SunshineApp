...
public class ForecastFragment extends Fragment {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_refresh) {
            ...
            fetchWeatherTast.execute("94043");
        }
    ...
    class FetchWeatherTast extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... params) {
            ...
            String units = "metric";
            int numDays = 7;
            String APPID = "51ea79ca4b2c0784b0ad9c0f36a1e582";

            try {
//                String baseUrl = "http://api.openweathermap.org/data/2.5/forecast/daily?q=94043&mode=json&units=metric&cnt=7";
//                String apiKey = "&APPID=" + "51ea79ca4b2c0784b0ad9c0f36a1e582";
                ...
                Log.v("LOGOSE", "Built URI " + buildUri.toString());
